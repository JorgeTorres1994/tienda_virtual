          ...
          <ul class="list-unstyled templatemo-accordion">
            <li class="pb-3">
              ...
              <ul class="collapse show list-unstyled pl-3">
                <li>
                  <a class="text-decoration-none" href="iphones.html"
                    >Iphones</a
                  >
                </li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 pt-5">
            ...
            <ul class="list-unstyled text-light footer-link-list">
              <li>
                <a class="text-decoration-none" href="#">Celulares Iphone</a>
              </li>
              <li>
                <a class="text-decoration-none" href="#">Cables certificados</a>
              </li>
              <li>
                <a class="text-decoration-none" href="#">Cables originales</a>
              </li>
        ...
        <div class="container">
          <div class="row pt-2">
            <div class="col-12">
              ...
              <p class="text-left text-light">
                Copyright &copy; 2024 Tienda Virtual | Desarrollado por Jorge
                Torres
              </p>
            </div>
          </div>
